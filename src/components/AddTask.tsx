        ...
        <div className={"w-6/8 " + (showAddTask ? "" : "hidden")}>
            <form>
                ...
                <div className="flex justify-end">
                    <button className="cursor-pointer border-blue-400 border-2 w-32 p-2 text-center rounded-lg hover:bg-blue-600 hover:text-white" type="submit" onClick={handleSubmit}>Add New Task</button>
